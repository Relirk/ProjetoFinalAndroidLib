package com.francisco.geovane.marcello.felipe.projetofinalandroidlib.components.customdialog
...
import com.francisco.geovane.marcello.felipe.projetofinalandroidlib.R
import com.francisco.geovane.marcello.felipe.projetofinalandroidlib.extensions.fromHtml
...
class CustomDialog : View.OnClickListener {
    ...
    private fun createDialog(activity: Activity, isCancelable: Boolean) {
